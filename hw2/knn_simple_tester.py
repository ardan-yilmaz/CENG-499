...
# Testing Results
distances = calculate_distances(train_data, test_data[0], 'L2')
...
knn_k2_acc = knn(train_data, train_labels, test_data, test_labels, 2, 'L2')
...
cv_k3_5f_acc = cross_validation(train_data, train_labels, 5, 3, 'L2')
